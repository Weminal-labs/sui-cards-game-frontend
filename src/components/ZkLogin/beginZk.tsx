...
export default async function beginZkLogin(provider: OpenIdProvider) {
  // Create a nonce
  ...
  const urlParamsBase = {
    nonce: nonce,
    redirect_uri: "https://sui-card-game.vercel.app/",
    response_type: "id_token",
    scope: "openid email profile",
  };
  let loginUrl = "https://sui-card-game.vercel.app/";
  switch (provider) {
    case "Google": {
...
export async function completeZkLogin(accounts: AccountData[]) {
